...
Kontakt        
        ...
        <div class="w-full text-2xl p-4 font-bold leading-loose">SKONTAKTUJ SIĘ ZE MNĄ!</div>
            ...
            <div class="w-full p-4 font-bold leading-loose font-serif">
            <p class="text-xl">PAULINA KULIGOWSKA</p>
            <p>+48 799 859 509</p>
            ...
            <div class="w-full p-4 font-bold">
              ...
              <a href="https://goo.gl/maps/KEjWpFwWMEvd9qNT7"> 
                <g-image src='~/assets/images/lw_map.webp' alt="directions map" />
              </a>
            </div>
        ...
        <div class="w-full p-4">
          ...
          <button type="submit" class=" w-full p-2 uppercase">Wyślij</button>
            </div>
        </div>
    </form>
        </div>
